...
└── src/
    ...
    │   ├── database.js             # 70+ функций работы с данными
...
| Визит | Открытие/закрытие визита, проверка открытых визитов, поиск отгрузки по QR-коду |
...
└── NavigationContainer
    └── AppNavigator (Stack)
        ...
        └── RoleNavigator
            ...
            │   │   ├── RouteMapScreen
            │   │   ├── VisitScreen (QR-поиск отгрузки, проверка открытых визитов)
...
- **QR-сканирование** — поиск отгрузки по QR-коду упаковки (действие в разделе «Действия»)
