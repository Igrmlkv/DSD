export {
  ...
  updateAuditVisit,
  getAuditVisit,
  listAuditVisitsByRoute,
  findDraftAuditByPoint,
  findLastSubmittedAuditByPoint,
  getAnyRoutePointForTesting,
  listAuditVisitsByUser,
  submitAuditVisit,
  upsertAuditAnswer,
  listAuditAnswers,
  getAuditAnswer,
  ...
  listAuditPhotos,
  deleteAuditPhoto,
  findAuditPhotoByHash,
  updateAuditPhotoUpload,
  listPendingAuditPhotos,
  saveKpiResult,
  listKpiResults,
  clearKpiResults,
  createMlJob,
