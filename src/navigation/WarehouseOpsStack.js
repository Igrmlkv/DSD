...
import AdjustInventoryScreen from '../screens/expeditor/AdjustInventoryScreen';
import CaptureOnHandScreen from '../screens/expeditor/CaptureOnHandScreen';
...
export default function WarehouseOpsStack() {
  return (
    <Stack.Navigator screenOptions={defaultScreenOptions}>
      ...
      <Stack.Screen name={SCREEN_NAMES.ADJUST_INVENTORY} component={AdjustInventoryScreen} options={{ title: i18n.t('adjustInventory.title') }} />
      <Stack.Screen name={SCREEN_NAMES.CAPTURE_ON_HAND} component={CaptureOnHandScreen} options={{ title: i18n.t('captureOnHand.title') }} />
